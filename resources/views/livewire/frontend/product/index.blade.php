<div>
    <div class="row">
        <div class="col-md-3">
            @if ($category->brands)            
            <div class="card">
                <div class="card-header"><h4>Filtrar por marcas</h4></div>
                <div class="card-body">
            ...
            @endif
            <div class="card mt-3">
                <div class="card-header"><h4>Ordenar por precio</h4></div>
                <div class="card-body">
                        <label class="d-block">
                            <input type="radio" name="priceSort" wire:model="priceInput" value="high-to-low" /> Mayor a Menor                            
                        </label>
                        <label class="d-block">
                            <input type="radio" name="priceSort" wire:model="priceInput" value="low-to-high" /> Menor a Mayor                          
                        </label>
                </div>
            </div>
        </div>
