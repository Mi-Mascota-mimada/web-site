                        ...
                        <tbody>
                            @forelse ($brands as $brand)
                                <tr>
                                    ...
                                    <td><img src="{{ Storage::url($brand->image) }}" alt="{{ $brand->name }}"  class="img-fluid" style="width: 70px; height:70px;"/></td>
                                    <td>{{ $brand->status == '1' ? 'hidden':'visible'}}</td>
                                    <td>
                                        <a href="#" wire:click="editBrand({{ $brand->id }})" data-bs-toggle="modal" data-bs-target="#updateBrandModal" class="btn btn-sm btn-warning">Edit</a>
